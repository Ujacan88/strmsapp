...
// CALC — vždy počíta tržbu/náklady pre zobrazenie v tabuľke
// Dashboard/KPI filtruje podľa stavu (Objednané + Realizované)
const CALC = r => {
  if (!r) return r;
...
function buildWhere(req) {
  ...
  // Filtrovanie podľa created_at (kedy bola zákazka vytvorená)
  if (rok && mesiac) {
    parts.push("created_at LIKE ?");
